...
class ActiveSupport::TestCase
  sig { params(fixture_name: NilClass, other_fixtures: NilClass).returns(T::Array[Book]) }
  sig { params(fixture_name: T.any(String, Symbol), other_fixtures: NilClass).returns(Book) }
  sig { params(fixture_name: T.any(String, Symbol), other_fixtures: T.any(String, Symbol)).returns(T::Array[Book]) }
  def books(fixture_name = nil, *other_fixtures); end
